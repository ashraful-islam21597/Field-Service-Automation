    ...
    def add_workbook_format(workbook):
        ...
        wbf['header_orange'] = workbook.add_format(
            {'bold': 1, 'align': 'center', 'bg_color': colors['gray'], 'font_color': '#000000',
             'font_name': 'Arial', 'num_format': '#,##0.00'})
        ...
        wbf['number_format'] = workbook.add_format({'num_format': '#,##0.00'})
        wbf['number_format'].set_border()
        wbf['normal_format'] = workbook.add_format({'align': 'center'})
        wbf['normal_format'].set_border()
        wbf['bold_number_format'] = workbook.add_format({'bold': 1, 'num_format': '#,##0.00'})
        wbf['bold_number_format'].set_border()
        wbf['only_bold'] = workbook.add_format({'bold': 1, 'align': 'right'})
        wbf['only_bold'].set_border()
